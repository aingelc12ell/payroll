...
class EmploymentInfoController extends \BaseController {
	...
	{
		$employmentinfos = EmploymentInfo::all();
		return View::make('employmentinfo.index', array('employmentinfos'=>$employmentinfos));
	}
	...
	public function store()
	{
	    ...
	    if ($v->fails())
	    {
	        return Redirect::to('employmentinfo/create?id=' . Input::get('employee_id'))->withErrors($v)->withInput(Input::get());
	    }
		else
		{
			$e =  new Salary;
			...
			return View::make('employmentinfo.store');
		}
	}
